...
<br/> <br/> 
     <center>
            <s:form id="domainForm" action="student_Studentlist" theme="simple">
                       名称: <s:textfield name="baseQuery.sname" placeholder="名称" />&nbsp;&nbsp;
            ...
            <table border="1" align="center">
					...
					<th colspan="2" width="11%"  align="center"><span><strong>操作</strong></span></th>
				</tr>
                <s:iterator value="pageList.rows" var="t">
					<tr style="background-color: white;">
						...
						<td><button type="button" class="btn1"
								onclick="updateDomain('student_updateAction.action?sid=<s:property value='sid'/>');">编辑</button></td>
						<td><button type="button" class="btn1"
								onclick="deleteDomain('student_delete.action?sid=<s:property value='sid'/>');">删除</button></td>
					</tr>
		         </s:iterator>
       </table>
