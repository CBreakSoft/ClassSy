...
<br/><br/>
        <center>
        <!-- action="score_list1" -->
            <s:form id="domainForm" action="score_list1" theme="simple" >
			...
			<br />
               <table border="1" >
                 <tr style="background-color: PowderBlue;">
					<th width="15%" ><span><strong>学生学号</strong></span></th>
					<th width="15%" ><span><strong>学生姓名</strong></span></th>
					<th width="15%" ><span><strong>学生班级</strong></span></th>
					<th width="15%" ><span><strong>课程编号</strong></span></th>
					<th width="20%" ><span><strong>所选课程</strong></span></th>
